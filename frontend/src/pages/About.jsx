      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-8">
          ...
          <div className="group relative transition-all duration-300 hover:scale-105">
            ...
            <div className="relative bg-white/50 backdrop-blur-sm p-8 rounded-xl shadow-xl">
              <div className="mb-4 inline-block">
                <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-indigo-800">
                  Our Mission
                </h3>
                <div className="h-0.5 w-16 bg-gradient-to-r from-purple-900 via-indigo-800 to-blue-900 mt-1"></div>
              </div>
        ...
        <div className="mt-16">
          <div className="text-center mb-10">
            ...
            <div className="h-0.5 w-16 bg-gradient-to-r from-purple-900 via-indigo-800 to-blue-900 mt-1 mx-auto"></div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group relative transition-all duration-300 hover:scale-105 hover:-translate-y-1">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-900/5 via-indigo-800/5 to-blue-900/5 rounded-xl -m-2 blur opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative bg-white/50 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                <div className="w-12 h-12 bg-gradient-to-r from-purple-900 via-indigo-800 to-blue-900 rounded-full flex items-center justify-center mb-4">
                  <span className="text-white text-xl font-bold">1</span>
                </div>
                <h4 className="text-lg font-semibold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-indigo-800">
                  Quality First
                </h4>
