...
const Footer = () => {
  return (
    <footer className="w-full bg-gradient-to-r from-gray-900 via-purple-950 to-indigo-950 text-gray-300 shadow-lg shadow-purple-900/30 border-t border-purple-900/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Discover premium fashion that embodies sophistication and
              elegance. Our collections are crafted with quality materials for
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">
              Quick Links
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-gray-400 hover:text-violet-400 transition-colors duration-300 flex items-center gap-2"
                >
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-3">
                <svg
                  ...
                  height="18"
                  fill="currentColor"
                  className="bi bi-geo-alt mt-1 text-violet-500"
                  viewBox="0 0 16 16"
                >
              ...
              <li className="flex items-center gap-3">
                <svg
                  ...
                  height="18"
                  fill="currentColor"
                  className="bi bi-telephone text-violet-500"
                  viewBox="0 0 16 16"
                >
              ...
              <li className="flex items-center gap-3">
                <svg
                  ...
                  height="18"
                  fill="currentColor"
                  className="bi bi-envelope text-violet-500"
                  viewBox="0 0 16 16"
                >
                  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                </svg>
                <span className="text-gray-400">support@yourshop.com</span>
              </li>
            </ul>
          </div>
        </div>
